...
var inputTemplate = ' <form id="input-form">  Position (Entre -240 and 240): <input id="x" type="number" name="quantity" min="-240" max="240" autofocus></form>';
...
var GameView = Mn.View.extend({
    ...
    behaviors: [AlterKey,ChariotBehavior],
    ...
    onAttach:function(){
        ...
        chariot = $('#chariot');
        tl.to(chariot, 0, {opacity:1},"intro2")
        // .to(chariot, 1, {scaleX:3,transformOrigin:"57% center"},"intro2")
        .fromTo($('#chariot g g path'), 1, {fill:color1}, {fill:color5},"intro2")
        .fromTo(chariot, 1, {left:"-50%",transformOrigin:"center center"}, {left:"50%",transformOrigin:"center center"},"intro2");
